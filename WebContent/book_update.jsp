...
<body>
	...
	<div class="col-sm-6 col-md-offset-3">
		<form method="post" action="book_management.do?update=1"
			onsubmit="return checkValue()" id="form1" name="form">
			<div class="form-group">
				<label>번호</label> <input type="text" name="isbn"
					class="form-control" value="${book.isbn }" required>
			</div>
			<div class="form-group">
				<label>제목</label> <input type="text" name="bname"
					class="form-control" value="${book.bname }" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label>출판사</label> <input type="text" name="publisher"
					class="form-control" value="${book.publisher }" required>
			</div>
			<div class="form-group">
				<label>장르</label> <input type="text" name="genre"
					class="form-control" value="${book.genre }" required>
			</div>
			<div class="form-group">
				<label>개수</label> <input type="text" name="count"
					class="form-control" value="${book.count }" required>
			</div>
